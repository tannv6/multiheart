export const msgs = [
    {
        msg: "Minh à, anh yêu em, anh có thể nói lời ấy với em cả nghìn lần."
    },
    {
        msg: `Từ ngày đầu tiên gặp em, anh đã yêu em rồi, yêu vẻ đẹp thuần khiết ,
    ...
    },
    {
        ...
        lo được cho em, sợ rằng sẽ mãi mãi mất em.`
    },
    {
        msg: `Đến ngày hôm nay, khi công việc đã có phần ổn định, anh đã quyết tâm bỏ lại tất cả dọn về đây,
        để được gặp em thường xuyên, và có cơ hội thể hiện tình cảm của anh dành cho em.`
    }
    ,
    {
        msg: `Qua những lần gặp em anh càng thấy yêu và thương em hơn, dù cho đôi
        lúc em tỏ ra lạnh lùng hay vô tình thì tình yêu của anh dành cho em vẫn không hề thay đổi.`
    },
    {
        msg: `Em có thể không phải là một cô gái xinh đẹp nhất trong mắt người khác,
        ...
        được vị trí của em trong trái tim anh.`
    },
    {
        msg: `Cuối cùng, anh muốn em biết rằng, Anh có thể không phải là một người
        ...
        nhưng anh sẽ cố không làm em buồn mỗi khi bên anh. Anh có thể không dành được cho 
        em những lời đường mật, nhưng anh có một trái tim chân thành dành trọn vẹn 
        cho em.`
    },
    {
        msg: `Anh sẽ cho em thấy rằng anh yêu em còn nhiều hơn những lời anh nói. Và không
        thứ gì trên đời này có thể ngăn cản được tình yêu của anh dành cho em.`
    },
    {
        msg: `Anh có thể không dành thời gian bên em nhiều được.
    ...
    {
        msg: `Hãy để anh chăm sóc em đến hết cuộc đời và hãy để <span>❣anh yêu em❣</span> em nhé!`
    },
    {
        msg: `Anh mong rằng sau này người anh cưới,
