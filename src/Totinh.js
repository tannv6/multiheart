...
function Totinh() {
    return <div style={{ background: "#000000", position: "fixed", top: 0, left: 0, right: 0, bottom: 0 }}>
        <center>
        ...
        <center>
            ...
            <font style={{ fontSize: "11pt" }}>
                ...
                <marquee behavior="scroll" direction="left" scrollamount="2" scrolldelay="20" width="50%">
                    <font face="Tahoma" size="2" color="#ffffff">Làm người yêu anh nhé!</font>
                </marquee><br />
